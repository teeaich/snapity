<?php
  ...
  */
  class ERunActions extends CWidget
  {
    ...
    */
    public static function touchUrl($url,$postData=null,$contentType=null)
    {
    ...
    * @return
    */
    public static function runBackground($useHttpClient=false,$useUrl=null,$httpClientConfig=array(),$internalHostInfo=null)
    {
    ...
    * @return boolean
    */
    protected function checkInterval($interval,$id)
    {
      if (empty($interval))
        return true;
    ...
    */
    protected function registerInterval($interval,$id)
    {
      if (!empty($interval))
      {
        $endTime = time();

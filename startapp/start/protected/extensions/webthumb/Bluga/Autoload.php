<?php
/**
 * Autoloader for Bluga code based on: http://svn.pear.php.net/PEAR2/Autoload/trunk/src/Autoload.php
 */
function Bluga_Autoload($class)
{
    if (substr($class, 0, 5) !== 'Bluga') {
        return false;
    }
...
if (function_exists('spl_autoload_register')) {
    if (!($_____t = spl_autoload_functions()) || !in_array('Bluga_Autoload', spl_autoload_functions())) {
        spl_autoload_register('Bluga_Autoload');
    ...
    function __autoload($class) { return Bluga_Autoload($class); }
}
